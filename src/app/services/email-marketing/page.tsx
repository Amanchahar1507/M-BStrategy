...
export default function EmailMarketingPage() {
    return (
        <div className="overflow-hidden">
            {/* ====== IMMERSIVE HERO ====== */}
            <section className="relative min-h-[75vh] flex items-center pt-32 pb-20 overflow-hidden" style={{ background: 'linear-gradient(135deg, #0a1628 0%, #0d2847 30%, #1a1145 60%, #0a1628 100%)' }}>
                {/* Background Image */}
                ...
                <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
                    <div className="absolute top-[20%] right-[10%] w-[500px] h-[500px] rounded-full opacity-30" style={{ background: "radial-gradient(circle, rgba(37, 99, 235, 0.5) 0%, transparent 70%)" }} />
                    <div className="absolute bottom-[-10%] left-[5%] w-[600px] h-[600px] rounded-full opacity-20" style={{ background: "radial-gradient(circle, rgba(139, 92, 246, 0.4) 0%, transparent 70%)" }} />
                </div>
                    ...
                    <div className="max-w-3xl">
                        ...
                        <FadeIn delay={0.4}>
                            ...
                            <div className="mt-10 flex flex-col sm:flex-row gap-4">
                                <Button href="/contact" variant="primary" className="shadow-[0_0_25px_rgba(37,99,235,0.5)]">
            ...
            <section className="relative py-20 bg-navy overflow-hidden">
                ...
                <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
                    <FadeIn className="text-center mb-12">
                        <h2 className="text-2xl font-bold text-white sm:text-3xl">The Numbers That <span className="gradient-text">Speak for Themselves</span></h2>
                    </FadeIn>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        {[
                            ...
                            <FadeIn key={stat.label} delay={i * 0.1}>
                                <div className="group rounded-2xl bg-white/5 border border-white/10 p-8 backdrop-blur-xl hover:bg-white/10 transition-all duration-300 shadow-lg hover:shadow-[0_0_30px_rgba(37,99,235,0.15)] text-center">
            ...
            <section className="relative py-28 overflow-hidden" style={{ background: 'linear-gradient(135deg, #f8fafc 0%, #eef2ff 30%, #f5f3ff 60%, #f8fafc 100%)' }}>
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-electric/3 rounded-full blur-[120px]" />

                <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="grid items-center gap-16 lg:grid-cols-2">
                        <FadeIn>
                            <div className="space-y-6">
                                <div className="inline-flex items-center gap-2 py-1.5 px-4 rounded-full bg-electric/5 border border-electric/10">
                                    <EnvelopeIcon className="h-4 w-4 text-electric" />
                                    <span className="text-sm font-semibold text-electric uppercase tracking-wider">Our Approach</span>
                                </div>
                                ...
                                <div className="relative pl-6 border-l-4 border-electric my-8 py-4 bg-white/80 rounded-r-2xl pr-6 shadow-sm">
            ...
            <section className="relative py-28 bg-navy overflow-hidden">
                ...
                <div className="absolute top-[30%] left-[50%] -translate-x-1/2 w-[800px] h-[800px] bg-electric/15 blur-[120px] rounded-full pointer-events-none" />
                    ...
                    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                        {services.map((f, i) => (
                            <FadeIn key={f.title} delay={i * 0.08}>
                                <div className="group relative h-full rounded-3xl bg-white/5 border border-white/10 p-8 hover:bg-white/10 transition-all duration-300 backdrop-blur-xl overflow-hidden shadow-lg hover:shadow-[0_0_30px_rgba(37,99,235,0.2)]">
                                    ...
                                    <div className="mb-5 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-electric/20 to-transparent border border-electric/30 text-electric-light group-hover:scale-110 transition-transform shadow-[0_0_15px_rgba(37,99,235,0.2)]">
                                        {f.icon}
                                    </div>
            ...
            <section className="relative py-28 overflow-hidden" style={{ background: 'linear-gradient(180deg, #f8fafc 0%, #eef2ff 50%, #f5f3ff 100%)' }}>
                <div className="absolute top-0 left-1/4 w-80 h-80 bg-electric/5 rounded-full blur-[80px] -mt-20" />
                ...
                <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="grid gap-16 lg:grid-cols-2">
                        ...
                        <FadeIn>
                            <div className="space-y-6">
                                <div className="inline-flex items-center gap-2 py-1.5 px-4 rounded-full bg-electric/5 border border-electric/10">
                                    <UserGroupIcon className="h-4 w-4 text-electric" />
                                    <span className="text-sm font-semibold text-electric uppercase tracking-wider">Who It&apos;s For</span>
                                </div>
                                ...
                                <div className="space-y-3 mt-6">
                                    {["E-commerce brands wanting more repeat purchases", "SaaS companies needing better onboarding flows", "Service businesses building client relationships", "Founders who want revenue on autopilot"].map((item, i) => (
                                        <div key={i} className="flex items-center gap-3 p-3 rounded-xl bg-white border border-gray-100 shadow-sm">
                                            <CheckCircleIcon className="h-5 w-5 text-electric flex-shrink-0" />
                ...
                <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
                    <FadeIn>
                        <h2 className="text-4xl font-bold text-white sm:text-5xl lg:text-6xl tracking-tight mb-8">
                            Ready to boost your <span className="italic gradient-text">email revenue?</span>
                        </h2>
