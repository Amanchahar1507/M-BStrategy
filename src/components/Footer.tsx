...
export default function Footer() {
    return (
        <footer className="relative bg-dark overflow-hidden text-white border-t border-white/5">
            <div className="relative z-10 mx-auto max-w-7xl px-6 py-20 lg:px-8">
                <div className="grid grid-cols-1 gap-12 lg:gap-16 md:grid-cols-2 lg:grid-cols-4">
                    {/* Brand Column */}
                    <div className="lg:col-span-1">
                        <div className="flex items-center gap-3 mb-6">
                            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-primary-dark text-white font-bold text-lg shadow-[0_0_15px_rgba(37,99,235,0.4)]">
                                M&B
                            </div>
                    ...
                    {/* Services */}
                    <div>
                        <h3 className="text-sm font-semibold uppercase tracking-wider text-primary-light mb-6">
                            Growth Services
                        </h3>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-4 text-sm text-gray-400 group">
                                <div className="mt-0.5 flex-shrink-0 w-8 h-8 rounded-full bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-primary/20 group-hover:border-primary/30 transition-colors">
                                    <EnvelopeIcon className="h-4 w-4 text-gray-300 group-hover:text-primary-light transition-colors" />
                                </div>
                            ...
                            <li className="flex items-start gap-4 text-sm text-gray-400 group">
                                <div className="mt-0.5 flex-shrink-0 w-8 h-8 rounded-full bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-primary/20 group-hover:border-primary/30 transition-colors">
                                    <PhoneIcon className="h-4 w-4 text-gray-300 group-hover:text-primary-light transition-colors" />
                                </div>
                                <span className="mt-1.5 hover:text-white transition-colors cursor-pointer">
                                    +1 (555) 000-0000
                                </span>
                            ...
                            <li className="flex items-start gap-4 text-sm text-gray-400 group">
                                <div className="mt-0.5 flex-shrink-0 w-8 h-8 rounded-full bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-primary/20 group-hover:border-primary/30 transition-colors">
                                    <MapPinIcon className="h-4 w-4 text-gray-300 group-hover:text-primary-light transition-colors" />
                                </div>
                                <span className="mt-1.5 hover:text-white transition-colors cursor-pointer">
